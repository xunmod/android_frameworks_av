...
#if (CONFIG_CHIP != OPTION_CHIP_1639 && CONFIG_CHIP != OPTION_CHIP_1673 && CONFIG_CHIP != OPTION_CHIP_1689)
...
#if ((CONFIG_PRODUCT == OPTION_PRODUCT_PAD && CONFIG_CHIP == OPTION_CHIP_1639)|| CONFIG_CHIP == OPTION_CHIP_1689)
